...
PROXY_URL = "socks5://NuhaiProxy_B7Hxe4u8:Bh1htnhm@45.128.149.44:30710"
...
async def main():
    ...
    # Создаём бота с кастомной сессией через SOCKS5 прокси и диспетчер
    session = SafeParseSession(proxy=PROXY_URL)
